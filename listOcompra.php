...
<div class="container mt-5">
    <div class="container"><div class="row justify-content-between">
        <div class="col-4"><a href="regOcompra.php" class="btn btn-secondary">Nueva Orden de Compra</a></div>
        <div class="col-4">
        ...
        $query = "SELECT oc.ID_OC, oc.ID_INSUMO, I.NOMBRE_I, oc.CANT_INSU, oc.FECHA, oc.DESCRI, p.NOM_PROV, oc.ID_USUARIO
                  FROM ORDEN_COM oc
                  JOIN INSUMO I ON oc.ID_INSUMO = I.ID_INSUMO               
                  JOIN PROV p ON oc.ID_PROV = p.ID_PROV";
        if (!empty($search)) {
            $query .= " WHERE oc.ID_OC LIKE '%' || :search || '%'";
        }
