...
<div class="container mt-5">
    <div class="container"><div class="row justify-content-between">
        ...
        while ($row = oci_fetch_array($stmt, OCI_ASSOC+OCI_RETURN_NULLS)) {
            ...
            echo "<td>
                <a href='actuVehiculos.php?placa=" . $row['PLACA'] . "' class='btn btn-primary btn-sm'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill=.'currentColor' class='bi bi-pencil-square' viewBox='0 0 16 16'>
