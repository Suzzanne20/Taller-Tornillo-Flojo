...
<?php
        ...
        $query = 'INSERT INTO ORDEN_P (FECHA, DESCRIPCION, MONTO, ID_SERVI  ) 
                  VALUES ( :fecha, :descripcion, :monto, :id_servi)';
    ...
    if (oci_execute($stmt)) {
        ...
        echo "<a href='regPagos.php' class='btn btn-primary mb-3'>Realizar otro Registro</a>";
        echo "<br></div></div></div>";
    } else {
