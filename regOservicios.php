...
<div class="container mt-5">
    ...
    <h1>Nueva Orden de Servicio</h1><br>
                <form action="registrarOservicio.php" method="post">
                    ...
                    <div class="form-group">
                        <label for="prox_serv">Proximo Servicio</label>
                        <input type="number" step="0.01" class="form-control" id="prox_serv" name="prox_serv">
                    </div>

                    <div class="input-group mb-3">
                        <label class="input-group-text" for="id_tipo">Placa</label>
